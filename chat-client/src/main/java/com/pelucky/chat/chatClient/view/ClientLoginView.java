...
import com.pelucky.chat.chatClient.controller.ClientLoginController;


/*
 * Login view of client
 */
public class ClientLoginView extends JFrame {
    ...
    public ClientLoginView() {
        ...
        // Add action listener in controller
    ...
    private void createAndShowGUI() {
        ...
        // Click close button will exit;
        frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        // Add all things into jPanel, and add jPanel into frame
        JPanel jPanel = new JPanel();
        frame.setContentPane(jPanel);
        // Don't use layout for simple
